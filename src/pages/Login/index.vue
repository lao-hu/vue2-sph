          ...
          <div class="content">
            <form action="##">
              <div class="input-text clearFix">
                <span></span>
                <input type="text" placeholder="邮箱/用户名/手机号" v-model="phone" maxlength="11">
              </div>
              <div class="input-text clearFix">
                <span class="pwd"></span>
                <input type="password" placeholder="请输入密码" v-model="password" maxlength="6">
              </div>
  ...
  export default {
    ...
    async  userLogin(){
        try {
          ...
          // 判断 路由当中是否有 query的参数，如果有就往参数地址跳转，没有就往home跳转
